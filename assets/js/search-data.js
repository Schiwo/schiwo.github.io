...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "git",
          description: "Some repositories with more or less interesting content.",
          section: "Navigation",
          handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6D.%73%63%68%69%6C%74%65%6E%77%6F%6C%66@%6C%6D%75.%64%65", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/moritz-schiltenwolf-07a068206", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=kOR7714AAAAJ", "_blank");
        },
      },{
      id: 'light-theme',
